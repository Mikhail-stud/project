...
class CreateRuleDialog(QDialog):
    ...
    # ─────────────────────────────────────────────────────────────
    # СЛОВАРЬ ПОДСКАЗОК (менять только здесь!)
    #
    # 
    # Значение = текст или HTML-подсказка, которая будет показана при клике
    # на иконку "i" справа от поля ввода.
    #
    # Чтобы добавить/изменить подсказку — просто допиcfnm сюда пару "ключ: текст".
    # ─────────────────────────────────────────────────────────────
    HELP_TEXTS = {
        ...
        "rules_ip_s": "<b>IP источника</b> — одиночный адрес, маска или any.",
        ...
        "rules_ip_d": "<b>IP получателя</b> — одиночный адрес, маска или any.",
    ...
    # === пытаемся создать правило через контроллер ===
